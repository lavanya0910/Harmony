...
<section class="login-block">
   ...
   <div class="form-group">
    ...
    <input type="text" name="use" id="use" onblur="fuc()"   class="form-control" placeholder="" required>
  </div>
    	 ...
    	 if (window.XMLHttpRequest) {
    	    ...
    	    xhttp.onreadystatechange = function() {
    	        if (this.readyState == 4 && this.status == 200) {
    	        	...
    	        	document.getElementById("error").innerHTML = "Otp is send to your registered Email id";
    	        	...
    	        	document.getElementById("error").innerHTML = "This Email ID is not registered,Use the same Email ID used during conference registartion";
    	        	var x = document.getElementById("error");
    	        	x.style.display = "block";
    	       }
    	        else
    	    ...
    	    xhttp.open("POST", "/Harmony/getotp?"+email, true);
  ...
  <div class="form-group">
  	<label style="color:red">Enter your OTP below</label><br>
    <label for="exampleInputPassword1" class="text-uppercase">PIN</label>
