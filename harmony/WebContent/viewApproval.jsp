...
<!--                                 <img alt="" src="img/avatar1_small.jpg"> -->
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i>Approved Papers</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="dashboard.jsp">Home</a></li>
              <li><i class="fa fa-laptop"></i>Approved Papers</li>
            </ol>
          </div>
        </div>
           <style>
...
<table class="table  table-light table-hover table-bordered text-justify">
  ...
  <tbody>
	...
	int i=0;
	 ...
	 List<PaperUplode> li=pd.Liss();
	 RegistrationDao r1=new  RegistrationDaoImpl();
	 Registration r2;
	 for(PaperUplode r:li)
	 {
		 i++;
		 r2=r1.get(r.getRegister_id()); 
