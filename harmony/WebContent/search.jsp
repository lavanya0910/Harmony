...
<table class="table  table-light table-hover table-bordered text-justify">
  ...
  <tbody>
	 ...
	 <tr>
	 <td>${message.getRegister_id()}</td>
	 <td>${message.getName()}</td>
	 <td>${message.getAddress()}</td>
	 <td>${message.getZipcode()}</td>
	 <td>${message.getCounter()}</td>
	 <td>${ message.getEmail()}</td>
	 <td>${message.getInstitution()}</td>
	 <td>${message.getSex()}</td>
	 <td>${message.getRemark()}</td>
	 <td class="bg-primary text-white">${message.getDate()}</td>
	 <td class="bg-primary text-white">${message.getTime()}</td>
	 <td class="bg-primary text-white">${message.getAmount()}</td>
	 <td class="bg-primary text-white">${message.getCurren()}</td>
	 <td class="bg-primary text-white">${message.getBankName()}</td>
	 <td class="bg-primary text-white">${message.getTranssactionalrefno()}</td>
	 <td class="bg-primary text-white">${message.getDateoftrans()}</td>
	 </tr>
	    </tbody>
    </table>
</div>
