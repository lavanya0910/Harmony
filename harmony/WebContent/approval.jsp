...
<!--                                 <img alt="" src="img/avatar1_small.jpg"> -->
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i>Approve Papers</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="dashboard.jsp">Home</a></li>
              <li><i class="fa fa-laptop"></i>Approve Papers</li>
            </ol>
          </div>
        </div>
  ...
  <thead>
    <tr>
	  ...
	  <tr class="text-center">
		...
		<th scope="col"><a href="#" class="btn btn-primary">Approval</a></th>
	</tr>
	</thead>
  <tbody>
	<% 
	...
	for(PaperUplode r:l)
	{
	 ...
	 <tr class="text-center">
	     <td><%= r.getPaper_id() %></td>
	      ...
	      <td scope="col"><a href="DownloadFileServlet?reg=<%= r.getRegister_id() %>">Download Paper</a>
	      <td scope="col"><a href="Approval?reg=<%= r.getRegister_id() %>" class="btn btn-primary">Approval</a></td>
<%-- 	 <td><%= r.get %></td> --%>
	 </tr>
 	<%} %> 
    </tbody>
