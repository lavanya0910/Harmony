...
<!--                                 <img alt="" src="img/avatar1_small.jpg"> -->
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i><b>Accomodation</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="dashboard.jsp"><b>Home</a></li>
              <li><i class="fa fa-laptop"></i><b>Accomodation</li>
            </ol>
          </div>
        </div>
  ...
  <center><strong><h3>${messs}</h3></strong></center> 
</div>
</c:if>
