...
<%  session.removeAttribute("message"); %>
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="#" class="logo">Har <span class="lite">mony</span></a>
      <!--logo end-->
 ...
 <%@include file="sidnav.jsp" %>
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i>View Status</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="dashboard.jsp">Home</a></li>
              <li><i class="fa fa-laptop"></i>View Status</li>
            </ol>
          </div>
        </div>
...
<table class="table  table-light table-hover table-bordered text-justify">
  <thead>
    <tr>
	  ...
	  <tr class="text-center">
		...
		<th scope="col">Paper Upload Date</th>
		<th scope="col">Paper Time Date</th>
		<th scope="col">Paper uploaded</th>
  ...
  <tbody>
	...
	%> 
	 ...
	 { %>
	 <td>No<br><a href="uploadpaper.jsp">Please upload the paper</a></td>
	 <%}
	 else
	 { %>
	 <td>Yes<br></td>  
	<% } %>
	<% if(!p.getStatus().equals("Approve")) 
	{
	%>
	 <td>Pending</td>
	 <%
